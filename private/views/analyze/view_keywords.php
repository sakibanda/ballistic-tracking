...
<script type="text/javascript">
	$("#keywords_table").table({dataTable: {
		bServerSide: true,
		aaSorting: [[1,'desc']],
		bSearchable: false,
		bFilter: false,
		iDisplayLength: 50,
		sAjaxSource: "/ajax/analyze/datakeywords",
		fnInitComplete: function() {
			$(".dataTables_length").hide();
			$(".dataTables_processing").hide();
		},
		aoColumns: [
			{ "bSortable": true }, //keyword
	...
	function exportCsv() {
		...
		iframe.src = '/analyze/exportKeywords?iSortCol_0=' + sort_col + '&sSortDir_0=' + sort_dir;
	}
</script>