...
<ul class="order_details">
    <li>Please use the following API KEY: <b style="font-size: 18px;"><?php echo str_replace("order_", "", $order->order_key);?></b> </li>
    <li>Download the Ballistic Tracking Software</li>
    <li>Please use the API KEY to active the software</li>
</ul>
