...
<div id="message" class="error">
	<p><?php printf( __( '%sYou have an out-of-date version of WooCommerce installed%s. WooCommerce Subscriptions requires WooCommerce 2.0.16 or newer. Please %supdate WooCommerce to the latest version%s.', self::$text_domain ), '<strong>', '</strong>', '<a href="' . admin_url( 'plugins.php' ) . '">', '</a>' ); ?></p>
</div>
<?php
		}
	}
