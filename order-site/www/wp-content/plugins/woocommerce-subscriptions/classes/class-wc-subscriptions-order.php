...
<div id="gateway_support"<?php if ( ! $contains_subscription ) echo $display_none; ?>>
	...
	<div class="error"<?php if ( ! $contains_subscription || $changes_supported == 'true' ) echo $display_none; ?>>
		<p><?php printf( __( 'The %s payment gateway is used to charge automatic subscription payments for this order. This gateway <strong>does not</strong> support changing a subscription\'s details.', WC_Subscriptions::$text_domain ), get_post_meta( $post_id, '_recurring_payment_method_title', true ) ); ?></p>
		<p>
