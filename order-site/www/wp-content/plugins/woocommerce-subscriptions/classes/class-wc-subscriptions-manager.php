...
class WC_Subscriptions_Manager {
	...
	public static function get_next_payment_date( $subscription_key, $user_id = '', $type = 'mysql' ) {
		...
		if ( false === $next_payment_date && 'active' == $subscription['status'] && self::get_subscriptions_completed_payment_count( $subscription_key ) < WC_Subscriptions_Order::get_subscription_length( $subscription['order_id'], $subscription['product_id'] ) )
