...
<?php else : ?>
	...
	<p><?php printf( __( 'You have no active subscriptions. Find your first subscription in the %sstore%s.', WC_Subscriptions::$text_domain ), '<a href="' . get_permalink( woocommerce_get_page_id( 'shop' ) ) . '">', '</a>' ); ?></p>
