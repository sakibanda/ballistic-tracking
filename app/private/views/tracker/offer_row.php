			...
			<tr class="no_row_borders">
				...
				<td style="width: 550px;">
                    <?php if(@$campoffer->offer->offer_id) { ?>
                        ...
                        <input maxlength="50" name="offer_name[]" type="hidden" value="<?php echo @$campoffer->offer->name; ?>" />
                    <?php } else { ?>
                        <input maxlength="50" name="offer_name[]" type="text" value="<?php echo @$campoffer->offer->name; ?>" />
                    <?php } ?>
                </td>
