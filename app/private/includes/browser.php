<?php
	...
	class Browser {
		...
		*/
	    ...
	    /**
	     * Determine if the browser is Facebook UA or not
	     * @return boolean True if the browser is Facebook UA otherwise false
	     */
	    protected function checkBrowserFacebook() {
		    if( stripos($this->_agent,'Facebook') !== false ) {
			    $aresult = explode(' ',stristr($this->_agent,'Facebook'));
		...
		public static function getPlatformName($id) {
			...
			return getArrayVar($platforms,$id);
		}
