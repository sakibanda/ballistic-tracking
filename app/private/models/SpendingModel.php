...
class SpendingModel extends BTModel {	
	public function tableName() {
		return 'bt_u_spending';
	}
	...
	public function rules() {
		return array(
			...
			array('date','callback',array('func'=>array($this,'checkDuplicateDate'),'message'=>'A spend for that date already exists','for'=>array('new'))),
			array('date','required',array('message'=>'Select a date','for'=>array('new'))),
			array('amount','required',array('message'=>'Enter a spend amount','for'=>array('new')))
		);
	}
